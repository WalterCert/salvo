...
public class SalvoController {
    ...
    private ResponseEntity<Object> setShipsPlayer(@PathVariable long gpid, @RequestBody List<Ship> ships,
    ...
    /*private List<Map<String, Object>> makePlayerList(Set<Player> players){
        ...
        game.getGamePlayers().stream().(gp -> myList.addAll(makeShipList(gp.getShips())));
        return myList;
    }*/
